...
EXPIRE_CLIENT_CACHE_AFTER_N_SECONDS_DEFAULT = decouple.config("EXPIRE_CLIENT_CACHE_AFTER_N_SECONDS_DEFAULT", default=60)
WAIT_FOR_N_SECONDS_BEFORE_FETCHING_LAYER_DETAILS = decouple.config("WAIT_FOR_N_SECONDS_BEFORE_FETCHING_LAYER_DETAILS", default=3)
